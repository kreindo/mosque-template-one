...
export const KegiatanBox = ({ title, children, dummy, phldr }) => {
  ...
  return (
    <div className="mb-[130px] w-[50%] relative">
      <h1 className="z-10 font-bold text-[24px] mb-[28px]">{title}</h1>
      <div className="absolute top-5 w-20 h-[10px] bg-warna-primary-maroon"></div>
